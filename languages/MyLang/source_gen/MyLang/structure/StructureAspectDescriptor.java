...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  private static ConceptDescriptor createDescriptorForElement() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("MyLang", "Element", 0xc840535e42134a05L, 0x832f5cc528f47f6eL, 0x12c827797081e311L);
    b.class_(false, true, false);
    b.origin("r:732bdf84-14c6-4711-9496-853be06f2200(MyLang.structure)/1353375090556920593");
    b.version(3);
    return b.create();
  }
  private static ConceptDescriptor createDescriptorForEmpty() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("MyLang", "Empty", 0xc840535e42134a05L, 0x832f5cc528f47f6eL, 0x12c827797085c707L);
    b.class_(false, false, false);
    // extends: MyLang.structure.Element
    b.super_(0xc840535e42134a05L, 0x832f5cc528f47f6eL, 0x12c827797081e311L);
    b.origin("r:732bdf84-14c6-4711-9496-853be06f2200(MyLang.structure)/1353375090557175559");
    b.version(3);
    return b.create();
  }
  private static ConceptDescriptor createDescriptorForState() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("MyLang", "State", 0xc840535e42134a05L, 0x832f5cc528f47f6eL, 0x12c827797080ae8fL);
    b.class_(false, false, false);
    // extends: MyLang.structure.Element
    b.super_(0xc840535e42134a05L, 0x832f5cc528f47f6eL, 0x12c827797081e311L);
    b.parent(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L);
    b.origin("r:732bdf84-14c6-4711-9496-853be06f2200(MyLang.structure)/1353375090556841615");
    b.version(3);
  ...
  private static ConceptDescriptor createDescriptorForStateMachine() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("MyLang", "StateMachine", 0xc840535e42134a05L, 0x832f5cc528f47f6eL, 0x12c827797081e306L);
    b.class_(false, false, true);
    b.parent(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L);
    b.origin("r:732bdf84-14c6-4711-9496-853be06f2200(MyLang.structure)/1353375090556920582");
    b.version(3);
  ...
  private static ConceptDescriptor createDescriptorForTransition() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("MyLang", "Transition", 0xc840535e42134a05L, 0x832f5cc528f47f6eL, 0x12c827797081e30bL);
    b.class_(false, false, false);
    // extends: MyLang.structure.Element
    b.super_(0xc840535e42134a05L, 0x832f5cc528f47f6eL, 0x12c827797081e311L);
    b.origin("r:732bdf84-14c6-4711-9496-853be06f2200(MyLang.structure)/1353375090556920587");
    b.version(3);
